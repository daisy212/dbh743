 ...
 * bool released, int key : active key, key1, key2 key3 key allready pressed
 */
{
// moved in MainTask
// KeyboardInit();
   ...
   while(1) 
   {
      while ( keybd.sleeping_soon < 10000) {
