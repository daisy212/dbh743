...
/*
#define BP_C1_I0_Pin    GPIO_PIN_0
#define BP_C1_I0_GPIO_Port GPIOA
#define C2_I1_Pin       GPIO_PIN_1
#define C2_I1_GPIO_Port    GPIOA
#define C3_I5_Pin       GPIO_PIN_5
#define C3_I5_GPIO_Port    GPIOA
#define C5_I13_Pin         GPIO_PIN_13
#define C5_I13_GPIO_Port   GPIOB
#define C6_I14_Pin         GPIO_PIN_14
#define C6_I14_GPIO_Port   GPIOB
#define RA_Pin          GPIO_PIN_8
#define RA_GPIO_Port    GPIOA
#define RB_Pin          GPIO_PIN_9
#define RB_GPIO_Port    GPIOA
#define RC_Pin          GPIO_PIN_10
#define RC_GPIO_Port    GPIOA
#define C4_I15_Pin         GPIO_PIN_15
#define C4_I15_GPIO_Port   GPIOA
#define RD_Pin          GPIO_PIN_3
#define RD_GPIO_Port    GPIOB
#define RE_Pin          GPIO_PIN_4
#define RE_GPIO_Port    GPIOB
#define RF_Pin          GPIO_PIN_5
#define RF_GPIO_Port    GPIOB
#define RG_Pin          GPIO_PIN_6
#define RG_GPIO_Port    GPIOB
#define RH_Pin          GPIO_PIN_7
#define RH_GPIO_Port    GPIOB
*/
#define BOOT_Pin        GPIO_PIN_3
#define BOOT_GPIO_Port     GPIOH

// common name with dbh743
#define COL_1_Pin GPIO_PIN_0
#define COL_1_GPIO_Port GPIOA
#define COL_2_Pin GPIO_PIN_1
#define COL_2_GPIO_Port GPIOA
...
#define COL_4_GPIO_Port GPIOA
#define COL_5_Pin GPIO_PIN_13
#define COL_5_GPIO_Port GPIOB
#define COL_6_Pin GPIO_PIN_14
...
#define ROW_B_GPIO_Port GPIOA
#define ROW_C_Pin GPIO_PIN_10
#define ROW_C_GPIO_Port GPIOA
#define ROW_D_Pin GPIO_PIN_3
#define ROW_D_GPIO_Port GPIOB
#define ROW_E_Pin GPIO_PIN_4
#define ROW_E_GPIO_Port GPIOB

#define ROW_F_Pin GPIO_PIN_5
#define ROW_F_GPIO_Port GPIOB
...
#define ROW_I_GPIO_Port GPIOH

// keyboard interrupt
#define COL_1_EXTI_IRQn EXTI0_IRQn
#define COL_2_EXTI_IRQn EXTI1_IRQn
#define COL_3_EXTI_IRQn EXTI2_IRQn
#define COL_4_EXTI_IRQn EXTI15_IRQn
#define COL_5_EXTI_IRQn EXTI13_IRQn
#define COL_6_EXTI_IRQn EXTI14_IRQn
