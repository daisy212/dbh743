...
//
//
// C:\segger\embOS_Ultra_CortexM_ES_Obj_SFL_V5.20.0.0\Start\BoardSupport\ST\STM32U585_weact_db\db48x\src\dmcp\target.h
//
// ****************************************************************************
...
#ifndef CONFIG_COLOR
    BITS_PER_PIXEL = 1,
    LCD_SCANLINE   = 400,			// passer à 400, les donnees de ctrl sont dans le buffer dma
#else
    BITS_PER_PIXEL = 16,
    LCD_SCANLINE   = 400,
#endif
...
// in Flash2 for h743, no modif normaly
#if DBh743
#define FONT_QSPI __attribute__((section(".FLASH2")))
#elif DBu585
#define FONT_QSPI 
#else
