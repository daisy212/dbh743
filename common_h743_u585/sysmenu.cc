...
Screen.text(x, 5, utf8("This project is powered by SEGGER Tools"), font);
Screen.text(x, 30, utf8("under the Segger's Friendly License, FSL"), font);
Screen.text(x, 55, utf8("with grateful thanks to SEGGER team"), font);


    for (uint i = 0; i < 2; i++)
        x2 = Screen.text(5+i, y, utf8(HARD_NAME " "), font, pattern::black);
    Screen.text(x2, y, utf8("v" HARD_VERSION " by d212"), font);
